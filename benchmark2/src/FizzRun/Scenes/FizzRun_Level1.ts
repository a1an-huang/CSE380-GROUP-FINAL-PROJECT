...
export default class Level1 extends FizzRun_Level {
    ...
    public unloadScene(): void {
        ...
        this.load.keepSpritesheet(Level1.PLAYER_SPRITE_KEY);
        this.load.keepAudio(Level1.JUMP_AUDIO_PATH);
        this.load.keepAudio(Level1.DEAD_AUDIO_PATH);
        this.load.keepAudio(Level1.TILE_DESTROYED_PATH);
